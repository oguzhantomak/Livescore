...
namespace Livescore.GetData
{
    public class Program
    {
        ...
        {
            string key = "642d1a14-2097-4b96-9af4-54c29b17451a";
            string languageId = "2";
            ...
            var url = $"https://s0-sports-data-api.broadage.com/soccer/match/list?date={todaysDate}";
